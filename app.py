...
.stTextInput input,.stNumberInput input{{
  ...
  border-radius:11px!important;color:{{'#64748B' if dm else '#000000'}}!important;font-size:14px!important;padding:10px 14px!important;
}}
...
.stSelectbox>div>div{{background:{INPUT_BG}!important;border:1.5px solid {CARD_BORDER}!important;border-radius:11px!important;color:{{'#64748B' if dm else '#000000'}}!important;}}
.stSelectbox span {{
